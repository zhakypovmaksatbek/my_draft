...
// enum ZoomDirection { increase, decrease }

// class MapNavigation extends StatelessWidget {
//   final DGisMapController mapController;

//   const MapNavigation({super.key, required this.mapController});
...
//         zoom: getZoom(cameraPosition.zoom),
//       ),
//       duration: duration,
...
//                 child: Icon(Icons.add_rounded, size: 25.0, color: Colors.white),
//               ),
//             ),
//           ),
